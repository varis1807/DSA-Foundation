public class linkedlist {
   ...
   //reverse ll in return type

    private Node reversePRHelper1(Node node) {
        if (node.next == null)
            return node;

        Node reverseNode = reversePRHelper1(node.next);
    ...
    public void reversePR1() {
        ...
        Node reverseNode = reversePRHelper1(head);
        reverseNode.next = null;
        head = tail;
        tail = reverseNode;
    }
//reverse ll with void type
